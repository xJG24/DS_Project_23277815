...
public final class TestingServiceGrpc {
  ...
  public static final String SERVICE_NAME = "testingService.TestingService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  @java.lang.Deprecated // Use {@link #getTestServicesMethod()} instead. 
  public static final io.grpc.MethodDescriptor<testingService.TestRequest,
      testingService.TestResponse> METHOD_TEST_SERVICES = getTestServicesMethodHelper();

  private static volatile io.grpc.MethodDescriptor<testingService.TestRequest,
      testingService.TestResponse> getTestServicesMethod;

  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static io.grpc.MethodDescriptor<testingService.TestRequest,
      testingService.TestResponse> getTestServicesMethod() {
    return getTestServicesMethodHelper();
  }

  private static io.grpc.MethodDescriptor<testingService.TestRequest,
      testingService.TestResponse> getTestServicesMethodHelper() {
    io.grpc.MethodDescriptor<testingService.TestRequest, testingService.TestResponse> getTestServicesMethod;
      ...
      synchronized (TestingServiceGrpc.class) {
        if ((getTestServicesMethod = TestingServiceGrpc.getTestServicesMethod) == null) {
          TestingServiceGrpc.getTestServicesMethod = getTestServicesMethod = 
              io.grpc.MethodDescriptor.<testingService.TestRequest, testingService.TestResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "testingService.TestingService", "testServices"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  testingService.TestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  testingService.TestResponse.getDefaultInstance()))
  ...
  public static abstract class TestingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void testServices(testingService.TestRequest request,
        io.grpc.stub.StreamObserver<testingService.TestResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                testingService.TestRequest,
                testingService.TestResponse>(
  ...
  public static final class TestingServiceBlockingStub extends io.grpc.stub.AbstractStub<TestingServiceBlockingStub> {
    ...
    /**
     */
    public testingService.TestResponse testServices(testingService.TestRequest request) {
  ...
  public static final class TestingServiceFutureStub extends io.grpc.stub.AbstractStub<TestingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<testingService.TestResponse> testServices(
        testingService.TestRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TEST_SERVICES:
          serviceImpl.testServices((testingService.TestRequest) request,
              (io.grpc.stub.StreamObserver<testingService.TestResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class TestingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return testingService.TestingServiceImpl.getDescriptor();
    }
